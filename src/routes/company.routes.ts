...
/**
 * Post Method to populate company data and an additional id
 * @Accepts Company Data
 * @Returns Company Data with populated UUID
 */
...
/**
 * Populates additional customer data to an existing company object
 * @Accepts CompanyID
 * @Returns Company Object with Customer Data
 */
...
/**
 * @Accepts UUID
 * @Returns Company Object matching with the UUID and customer data
 */
